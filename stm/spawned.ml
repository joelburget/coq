...
let open_bin_connection h pr pw = failwith "unimplemented: open_bin_connection"
(*
  let open Unix in
...
let init_channels () = failwith "unimplemented: init_channels"
(*
...
let process_id () = "unimplemented: process_id"
  (*
